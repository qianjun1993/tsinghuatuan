...
urlpatterns = patterns('',
                       ...
                       url(r'^feedback_list/$', 'adminpage.views.feedback_list'),
                       url(r'^feedback_post/$', 'adminpage.views.feedback_post'),
                        url(r'^item_list/$', 'adminpage.views.item_list'), 
                        url(r'^item_create/$', 'adminpage.views.item_create'),
                        url(r'^item_modify/$', 'adminpage.views.item_post'),
                        url(r'^exchange_list/$', 'adminpage.views.exchange_list'),
                       url(r'^exchange_post/$', 'adminpage.views.exchange_post'),  
                       )
